            ...
            <section id='projects' className='projects container-xl'>
                ...
                <div className='projects-content row '>
                    ...
                    <div className=' col-md-6 col-lg-4 mt-4 mt-md-0'>
                        <div className='card-content'>
                            <a href="https://wordtripviagens.netlify.app/" rel="noopener noreferrer" target='_blank'>
                        <div className='cardHeader'>
                        ...
                        <div className='card-button'>
                         <a href='https://github.com/lucasecp/world-trip' rel="noopener noreferrer" target='_blank'><FaGithub />github</a>
                         <a href='https://wordtripviagens.netlify.app/' rel="noopener noreferrer" target='_blank'><FaArrowRight/>Acessar</a>
                        </div>
                        </div>
                    </div>
